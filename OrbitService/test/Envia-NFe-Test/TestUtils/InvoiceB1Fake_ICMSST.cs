...
{
    public class InvoiceB1Fake_ICMSST
    {
        public static Invoice GetFakeInvoiceB1()
        {
            ...
            identificacao.DadosCobranca = 157.67;
            ...
            invoice.TipoNF = "0";
            identificacao.ValorTotalNF = 157.67;
            #endregion
            ...
            line.QuantidadeLinha = 2;
            line.ValorUnitarioLinha = 60.00;
            line.ValorTotalLinnha = 120.00;
            ...
            impostoLinha.ValorImposto = 9.03;
            impostoLinha.ValorBaseImposto = 129.03;
            impostoLinha.PorcentagemImposto = 7;
            ...
            impostoLinha.ValorImposto = 37.67;
            impostoLinha.ValorBaseImposto = 259.48;
            ...
            impostoLinha.ValorImposto = 0.78;
            impostoLinha.ValorBaseImposto = 120.00;
            listImpostoLinha.Add(impostoLinha);
            #endregion PIS
            ...
            impostoLinha.ValorImposto = 3.60;
            impostoLinha.ValorBaseImposto = 120.00;
            listImpostoLinha.Add(impostoLinha);
            #endregion COFINS
