...
{
    internal class InvoiceB1Fake_FCP_DIFAL
    {
        public static Invoice GetFakeInvoiceB1()
        {
            ...
            identificacao.DadosCobranca = 540.00;
            ...
            invoice.TipoNF = "0";
            identificacao.ValorTotalNF = 540.00;
            #endregion
            ...
            line.QuantidadeLinha = 10;
            line.ValorUnitarioLinha = 50.00;
            line.ValorTotalLinnha = 500.00;
            ...
            impostoLinha.ValorBaseImposto = 540.00;
            ...
            impostoLinha.ValorImposto = 75.60;
            impostoLinha.ValorBaseImposto = 540.00;
            impostoLinha.PorcentagemImposto = 4;
            ...
            impostoLinha.ValorImposto = 10.80;
            ...
            impostoLinha.ValorImposto = 3.25;
            impostoLinha.ValorBaseImposto = 500.00;
            listImpostoLinha.Add(impostoLinha);
            #endregion PIS
            ...
            impostoLinha.ValorImposto = 15.00;
            impostoLinha.ValorBaseImposto = 500.00;
            listImpostoLinha.Add(impostoLinha);
            #endregion COFINS
            ...
            impostoLinha.ValorImposto = 40.00;
            impostoLinha.ValorBaseImposto = 500.00;
            listImpostoLinha.Add(impostoLinha);
            #endregion IPI
            ...
            duplicata.ValorDuplicata = 540.00;
