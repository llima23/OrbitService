    ...
    public class DBServiceConfigurationRepository: ServiceConfigurationRepository
    {
        ...
        public ServiceConfiguration GetConfiguration()
        {
            ...
            if (VerifyIfTableConfigAddonExist())
            {
                ...
                {
                    return new ServiceConfiguration(null, null, null, new Guid());
                }
                ...
                ServiceConfiguration sConfig = new ServiceConfiguration(new Uri(baseURIString), username, password, new Guid(tenant));
