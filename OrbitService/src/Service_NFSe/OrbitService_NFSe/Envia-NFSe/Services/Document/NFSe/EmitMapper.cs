        ...
        public EmitRequestInput ConvertToOrbitObject(NFSeB1Object b1Document)
        {
            try
            {
                ...
                foreach (var Linhas in b1Document.Linhas)
                {
                    ...
                    foreach (var LineTaxWithholding in b1Document.LinesTaxWithholding.Where(x => x.Doc1LineNo == Convert.ToString(Linhas.LineNum)))
                    {
                        if (!String.IsNullOrEmpty(LineTaxWithholding.U_TAX4_TpImp) && Linhas.WtLiable == "Y")
                        {
                            switch (LineTaxWithholding.U_TAX4_TpImp)
                            {
                                ...
                                case "1":
                                    ...
                                    requestInput.rps.servico.valores.pis.baseCalculo = ToOrbitString(LineTotal);
                                    break;
                                case "2":
                                    ...
                                    requestInput.rps.servico.valores.cofins.baseCalculo = ToOrbitString(LineTotal);
                                    break;
                                case "3":
                                    ...
                                    requestInput.rps.servico.valores.ir.baseCalculo = ToOrbitString(LineTotal);
                                    break;
                                case "4":
                                    ...
                                    requestInput.rps.servico.valores.csll.baseCalculo = ToOrbitString(LineTotal);
                                    break;
                                case "5":
                                    ...
                                    requestInput.rps.servico.valores.inss.baseCalculo = ToOrbitString(LineTotal);
                                    break;
                                case "6":
                    ...
                    foreach (var LineTax in b1Document.LinesTax.Where(x => x.LineNum == Convert.ToString(Linhas.LineNum)))
                    {
                        if (!String.IsNullOrEmpty(LineTax.U_TAX4_TpImp) && LineTax.TaxSum > 0 && LineTax.TaxInPrice == "N")
                        {
                        ...
                        if (LineTax.U_TAX4_TpImp == "-7" && !requestInput.rps.servico.valores.iss.retido)
                        {
                    ...
                    requestInput.rps.servico.valores.inss.valor = Math.Round(requestInput.rps.servico.valores.inss.valor, 6);
                    requestInput.rps.servico.valores.cofins.valor = Math.Round(requestInput.rps.servico.valores.cofins.valor, 6);
                    requestInput.rps.servico.valores.pis.valor = Math.Round(requestInput.rps.servico.valores.pis.valor, 6);
