...
{
    public class OutboundNFeDocumentRegisterInput
    {
        ...
        public bool ShouldSerializetransp()
        {
            return !string.IsNullOrEmpty(transp.ModFrete);
        }
    ...
    public class Prod
    {
        ...
        {
            return !string.IsNullOrEmpty(ValorSeguro);
        }
