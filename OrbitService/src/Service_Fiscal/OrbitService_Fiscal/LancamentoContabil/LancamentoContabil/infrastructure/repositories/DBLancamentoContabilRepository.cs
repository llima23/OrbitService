...
namespace AccountService_LancamentoContabil.LancamentoContabil.infrastructure.repositories
{
    public class DBLancamentoContabilRepository : IDBLancamentoContabilRepository
    {
        ...
        public string queryHeaderLCM = @"SELECT TOP 10 DISTINCT
                                                ...
                                                WHERE T0.""U_TAX4_LIDO"" = 'N' AND T0.""U_TAX4_Stat"" is null or T0.""U_TAX4_Stat"" like '' ";
        ...
        {
            return wrapper.ExecuteNonQuery(@$"UPDATE OJDT SET ""U_TAX4_LIDO"" = 'S', ""U_TAX4_Stat"" = 'Carga Efetuada', ""U_TAX4_IdRet"" = '{output.header.id}' WHERE ""TransId"" = '{lcm.header.TransId}'");
        }
        public int UpdateAccountStatusError(LancamentoContabilB1 lcm, LancamentoContabilError output)
        {
            ...
            return wrapper.ExecuteNonQuery(@$"UPDATE OJDT SET ""U_TAX4_LIDO"" = 'N', ""U_TAX4_Stat"" = '{messageError}' WHERE ""TransId"" = '{lcm.header.TransId}'");
        }

        public int UpdateAccountStatusErrorException(int lcm, string error)
        {
            return wrapper.ExecuteNonQuery(@$"UPDATE OJDT SET ""U_TAX4_LIDO"" = 'S', ""U_TAX4_Stat"" = '{error}', ""U_TAX4_IdRet"" = null WHERE ""TransId"" = '{lcm}'");
        }
