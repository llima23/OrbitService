...
namespace _4TAX_Service.Common.Domain.Properties.Orbit.Document_Service
{
    public class NFSe
    {
        public class Alvara
        ...
        public class DocumentServiceNFSe
        {
            public List<string> emails { get; set; }
            public string branchId { get; set; }
            public string erpId { get; set; }
            public string isForceProductionEnv { get; set; }
        ...
        public class Servico
        {
            ...
            public DetDeducoes detDeducoes { get; set; }
            public string codigoPais { get; set; }
        ...
        {
            public int valorTotalTributos { get; set; }
            public double totalServicos { get; set; }
            public int totalDeducoes { get; set; }
