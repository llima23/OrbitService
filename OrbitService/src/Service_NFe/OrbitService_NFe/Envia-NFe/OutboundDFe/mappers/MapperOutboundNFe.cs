...
namespace OrbitService.OutboundDFe.mappers
{
    public class MapperOutboundNFe
    {
        ...
        public DocumentStatus ToDocumentStatusResponseSucessful(Invoice invoice, OutboundNFeDocumentRegisterOutput output, string message)
        {
        ...
        public List<Det> ReturnListDetInboundNFe(Invoice invoice)
        {
            ...
            foreach (var item in invoice.CabecalhoLinha.OrderBy(c => c.NItem))
            {
                Det det = new Det();
