...
namespace OrbitService.FiscalBrazil.mappers
{
    public class MapperInboundCce
    {
        ...
        public InboundCceInput ToInboundCceRegisterInput(Invoice invoice)
        {
            ...
            input.data.emitente.endereco.codigoMunicipio = Convert.ToInt16(invoice.Parceiro.CodigoIBGEMunicipioParceiro);
            ...
            input.data.emitente.endereco.fone = !String.IsNullOrEmpty(invoice.Parceiro.FoneParceiro) ? Convert.ToInt16(Regex.Replace(invoice.Parceiro.FoneParceiro, @"\.|\/|-", "")) : 0;
            ...
            input.data.destinatario.endereco.codigoMunicipio = Convert.ToInt16(invoice.Filial.CodigoIBGEMunicipioFilial);
